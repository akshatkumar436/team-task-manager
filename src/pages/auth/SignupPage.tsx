  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      <aside className="hidden w-1/2 flex-col justify-between bg-slate-950 p-12 lg:flex">
        ...
        <div>
          <p className="text-xs font-medium uppercase tracking-widest text-blue-300">Start a workspace</p>
          <h2 className="mt-4 max-w-md text-3xl font-semibold leading-tight text-white">
            Create projects, invite teammates, and keep every task moving.
          </h2>
          <p className="mt-4 max-w-md text-sm leading-6 text-slate-400">
            Use clear priorities, due dates, project boards, and activity history to manage work with confidence.
          </p>
        </div>
      ...
      <main className="flex flex-1 items-center justify-center p-6">
        ...
        >
          ...
          <p className="mb-7 text-sm text-slate-500">Start managing your team's work</p>

          {!isSupabaseConfigured && (
            <div className="mb-5 rounded-lg border border-amber-200 bg-amber-50 px-3.5 py-3 text-xs text-amber-800">
              Add VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY to `.env` to enable sign up.
            </div>
          )}
